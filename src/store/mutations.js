...
export default {
  ...
  SET_UPGRADE_CONSTRAINTS: (state, upgradeConstraints) => state.upgradeConstraints = upgradeConstraints,
  SET_UPGRADE_NUMBER: (state, payload) => state.upgrades[payload.upgradeID].number = payload.number,
